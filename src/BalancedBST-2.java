...
// Метод IsRight имеет временную сложность O(n) и пространственную сложность O(h), где nn — число узлов, а hh — высота дерева, так как использует рекурсивный обход дерева.
